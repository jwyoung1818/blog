...
//         if(i == 1)
//             s = 3;
//         return results[value] = cs[s];
//         //return results[value] = "hsl(30, 80%," + (end - s * scale) * 100 + "%)";
//       };
...
//       return color;
//     };
//     colors = ['#FFE5CC', '#FFCC99', '#ff9e66', '#ed6a3b', '#d64b33'];
...
//               trigger: 'click',
//               content: t + 'ms\n' + q,
//               template: '<div class="popover">' + '<div class="popover-content" >' + '</div><div  align="center" class="popover-footer"><button type="button" class="btn btn-primary popover-submit">' + '<i class="icon-ok icon-white">Paginate</i></button>&nbsp;</div></div>',
//               placement: 'right'
//             });
//           });
//         }
